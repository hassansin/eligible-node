 ...
 */
function APIErrorResponseError(message, code, response){
    EligibleError.call(this, message, code);     
    this.response = response;         
}
inherits(APIErrorResponseError, EligibleError);
exports.APIErrorResponseError = APIErrorResponseError;
 ...
 */
function InvalidRequestError(message, code, params){
    EligibleError.call(this, message, code);   
    this.params = params;     
}
